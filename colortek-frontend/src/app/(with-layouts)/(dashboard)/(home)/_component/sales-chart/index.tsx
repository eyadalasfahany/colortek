            ...
            <AreaChart data={chartData.data} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
              ...
              <defs>
                <linearGradient id="background" x1="0" y1="0" x2="0" y2="1">
                  <stop offset={"5%"} stopColor="var(--color-orange-500)" stopOpacity={0.2} />
              ...
              />
              <Tooltip
                cursor={{ stroke: "var(--color-neutral-400)", strokeWidth: 1, strokeDasharray: "4 4" }}
              ...
              <Area
                ...
                fill="url(#background)"
                dot={false}
                activeDot={{ r: 4, fill: "var(--color-orange-500)", stroke: "var(--color-white)", strokeWidth: 2 }}
              />
              <Area
                type="monotone"
                dataKey="revenue"
                ...
                fill="transparent"
                dot={false}
                activeDot={{ r: 4, fill: "var(--color-brand-purple)", stroke: "var(--color-white)", strokeWidth: 2 }}
              />
            </AreaChart>
          </ChartContainer>
        )}

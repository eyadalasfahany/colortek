        ...
        {securityItems.map(({ icon: Icon, title, description, actionLabel }) => (
          ...
          >
            ...
            <Button
              ...
              variant="ghost"
              size="sm"
              className="h-auto shrink-0 rounded-none py-2 pe-0 text-base text-brand-500 hover:bg-transparent hover:text-brand-600 focus:ring-0"
      ...
      <OverlayWrapper isOpen={openPasswordDialog} onOpenChange={setOpenPasswordDialog}>
        <Backdrop isDismissable>
          <Dialog className="max-w-108.75 p-0">
            ...
            >
              <DialogHeader className="gap-1 border-b border-card-border py-4 pe-14 ps-5">
